...
!                                                                       
      SUBROUTINE BASIS3 (ICALL, L, XLOC, YLOC, ZLOC, F, W, &
                         ...
                         VXG, VYG, VZG, SWG,SLLG,SIIG,SIOUTG,SII1G,CFREEZG, RHOG, VISCG, PORG, VGMAG, RELKG, &
      ...
      use SutraStorage, ONLY : IN, X, Y, Z, PITER, UITER, PVEL, &
                               GXSI, GETA, GZET, RCIT, RCITM1,SIOUT,SII1,CFREEZ
      ...
      real (DP) :: &
        ...
        TEQN, &
        DSWDPG,SLLG,DSLDPG,DSLDTG,SIIG,SIOUTG,SII1G,CFREEZG,DSIDPG,DSIDTG, &                             !!
        DENOM, &
        PGX, PGY, PGZ, &
...
!                                                                       
      ...
      DO IL = 1, 8 
         ...
         END DO
         SIOUTG=SIOUTG+SIOUT(I)/8   !!!
         SII1G=SII1G+SII1(I)/8
         CFREEZG=CFREEZG+CFREEZ(I)/8
      END DO 
!                                                                       
...
!IF (L.EQ.1) THEN
!                  WRITE ( * , * )'ELEMENT 00,NODE 00'
!                   WRITE ( * , * )'SW=',SWG ,'SL=',SLLG,'SI=',SIIG,'RELK=',RELKG 
!                
!END IF   


CALL ALLSAT (SWG, DSWDPG,SLLG,DSLDPG,DSLDTG,SIIG,DSIDPG,DSIDTG, RELKG, PITERG,UITERG(1), ElemMap(L),SIOUTG ,UITERG(2),SII1G,CFREEZG)  
! CALL ALLSAT (SWG, DSWDPG,SLLG,DSLDPG,DSLDTG,SIIG,DSIDPG,DSIDTG, RELKG, PITERG,UITERG(1), ElemMap(L) )          !!
!SWG = 1.0D0 
!SLLG=1.0
!SIIG=0   
!RELKG = 1.0D0 
