!
      MODULE  TECPLOT
        ...
        LOGICAL                           :: LTpP,LTpU,LTpSW,LTpSL,LTpSI,LTpRho,LTpTotalHead,LTpVelocity, &    !!
        ...
        public :: &
               ...
               LTpP,LTpU,LTpSW,LTpSL,LTpSI,LTpRho,LTpTotalHead,LTpVelocity,LTpPrintVelocity, LTpPrintVelocityAtNodes, &
...
!...........FUNCTION TO OUTPUT NODE DATA TO TECPLOT FILES
          logical function PrintTecplotNodeData() 
            USE SutraStorage, ONLY: PVEC, UVEC, SW, SLL,SII,RHO, IN, X, Y, Z
            IMPLICIT NONE
!.............locals
...
!.............TRANSIENT DATA                                                    
     1000   CONTINUE 
            ...
            ENDIF 
            IF (LTpSL) THEN 
               WRITE (IUNIT, 200) (SLL (I), I = 1, NN) 
            ENDIF 
            IF (LTpSI) THEN 
               WRITE (IUNIT, 200) (SII (I), I = 1, NN) 
            ENDIF 
