...
!                                                                       
      SUBROUTINE BASIS2 (ICALL, L, XLOC, YLOC, F, W, DET,     &
                         ...
                         THICKG, VXG, VYG, SWG,SLLG,SIIG,SIOUTG,SII1G,CFREEZG, RHOG, VISCG, PORG, VGMAG, RELKG, &
      ...
      use SutraStorage, ONLY : IN, X, Y, PITER, UITER, PVEL, THICK=>Z, &
                               GXSI, GETA, RCIT, RCITM1,SIOUT,SII1,CFREEZ
...
!                                                                       
      ...
      DO IL = 1, 4 
         ...
         END DO
         SIOUTG=SIOUTG+SIOUT(I)/4   !!!
         SII1G=SII1G+SII1(I)/4
         CFREEZG=CFREEZG+CFREEZ(I)/4
         !SIOUTG = SIOUTG + SIOUT (I) * F (IL) 
!         write(20240723,'(1I,10E15.6e3)')  I,PITERG
      END DO 
! 
!write(20240723,'(10E15.6e3)')  PITERG      
...
!.....VISCG IS A FUNCTION OF CONCENTRATION AND/OR TEMPERATURE           
 ...
 1400  CONTINUE 
!                                                                       
!write(20240723,'(10E15.6e3)')  SWG,SLLG,SIIG,RELKG
!!.....SET UNSATURATED FLOW PARAMETERS SWG AND RELKG                     
!      IF (IUNSAT - 2) 1600, 1500, 1600 
! 1500 IF (PITERG) 1550, 1600, 1600 
1550 CALL ALLSAT (SWG, DSWDPG,SLLG,DSLDPG,DSLDTG,SIIG,DSIDPG,DSIDTG, RELKG, PITERG,UITERG(1), ElemMap(L),SIOUTG ,UITERG(2),SII1G,CFREEZG)      ! 
