clc; clear all;
filePath = 'E:\SUTRA\Validation4-Solute variations\experiment data for experiment 2.xlsx';
...
time=6480;
name1='E:\SUTRA\Validation4-Solute variations\Column experiment 2-H=80cm';
...
sl = readmatrix('E:\SUTRA\Validation4-Solute variations\SHAW for experiment2.xlsx', 'Sheet', 'moisture');
wd = readmatrix('E:\SUTRA\Validation4-Solute variations\SHAW for experiment2.xlsx', 'Sheet', 'temp');
yd = readmatrix('E:\SUTRA\Validation4-Solute variations\SHAW for experiment2.xlsx', 'Sheet', 'conc');
